...
foreach($datos['Horarios'] as $key=>$horario){
    $pdf->Row(array(  utf8_decode( $horario['materia'] )    ,utf8_decode( $horario['grupo'] )   , utf8_decode( $horario['creditos'] )   ,  utf8_decode($horario['Lunes']), utf8_decode($horario['Martes']), utf8_decode($horario['Miercoles']), utf8_decode($horario['Jueves']), utf8_decode($horario['Viernes']), utf8_decode($horario['Sabado']  )            ));
}
$pdf->Output();
?>
